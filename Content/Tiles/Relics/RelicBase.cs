...
namespace ShatteredIllusion.Content.Tiles.Relics
{
    public abstract class RelicBase : ModTile
    {
        ...
        private const string Path = "ShatteredIllusion/Content/Tiles/Relics/";

        protected string RelicTextureName => Path + Name;
        // Points to RelicBase.png in your folder
        public override string Texture => Path + "RelicBase";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            int itemType = placeStyle == 0 ? ItemType : 0;
